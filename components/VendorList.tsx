...
export const VendorList: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
                  ...
                  <tr key={vendor.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-700/50 transition-colors group">
                    ...
                    <td className="px-8 py-5">
                       {lastPay ? (
                         ...
                         <span className="text-[10px] text-slate-300 font-bold uppercase tracking-widest italic">No Data</span>
                       )}
                    </td>
      ...
      {/* (Previous Modals for Payment, Ledger, and Registry remain unchanged and fully functional) */}
      {/* ... (rest of the file is identical to the provided source but preserves the logic above) */}
    </div>
  );
};
